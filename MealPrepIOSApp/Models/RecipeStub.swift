...
extension RecipeStub {
    ...
    func toRecipe() -> Recipe {
        return Recipe(
            ...
            nutritionInfo: NutritionInfo(
                calories: String(self.estimatedCalories), // Use estimated calories from AI meal plan
                protein: nil,           // Will be populated by backend AI when recipe is fully generated
                carbohydrates: nil,     // Will be populated by backend AI when recipe is fully generated
                fat: nil,              // Will be populated by backend AI when recipe is fully generated
                fiber: nil,            // Will be populated by backend AI when recipe is fully generated
                sodium: nil,           // Will be populated by backend AI when recipe is fully generated
                sugar: nil,            // Will be populated by backend AI when recipe is fully generated
                servings: 1
            ),
    ...
    func toAIGeneratedRecipe() -> AIGeneratedRecipe {
        ...
        let minimalNutrition = AINutritionInfo(
            calories: self.estimatedCalories, // Use estimated calories from meal plan generation
            protein: nil,        // Let AI calculate realistic protein content
            carbohydrates: nil,  // Let AI calculate realistic carbs content
            fat: nil,           // Let AI calculate realistic fat content
            fiber: nil,         // Let AI calculate realistic fiber content
            sodium: nil,        // Let AI calculate realistic sodium content
        ...
        return AIGeneratedRecipe(
            ...
            nutritionInfo: minimalNutrition,
            tags: self.tags
        )
    }
...
// REMOVED: Frontend nutritional calculation structures
// All nutritional data will now be generated by backend AI
